...
st.write(
    "Для просмотра данных только по выжившим или погибшим, выберите соответсвующий пункт из списка:"
)

selected = st.selectbox("Значение поля Survived:", ("Выжившие", "Погибшие"))

if selected == "Выжившие":
    st.write(
        f"Среднее количество родственников у выживших пассажиров: {calculate_average(survived)}"
    )
else:
    st.write(
        f"Среднее количество родственников у погибших пассажиров: {calculate_average(dead)}"
    )
